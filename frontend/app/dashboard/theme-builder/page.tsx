...
export default function ThemeBuilderPage() {
  ...
  // Convert hex to oklch for CSS output (proper conversion)
  const hexToOklch = (hex: string): string => {
    ...
    // Linear RGB to OKLab (using the proper matrix)
    ...
    const bVal = 0.0259040371 * l_3 + 0.7827717662 * m_3 - 0.8086757660 * s_3;
  ...
  // Generate CSS for globals.css - Tailwind v4 @theme format
  const generateGlobalsCss = (): string => {
    return `/* ============================================
   Theme: ${theme.name}
   Generated by Theme Builder
   Replace the @theme inline block in globals.css
   ============================================ */

@theme inline {
  --color-background: ${hexToOklch(theme.colors.background)};
  --color-foreground: ${hexToOklch(theme.colors.foreground)};
  --color-card: ${hexToOklch(theme.colors.card)};
  --color-card-foreground: ${hexToOklch(theme.colors.cardForeground)};
  --color-popover: ${hexToOklch(theme.colors.card)};
  --color-popover-foreground: ${hexToOklch(theme.colors.cardForeground)};
  --color-primary: ${hexToOklch(theme.colors.primary)};
  --color-primary-foreground: ${hexToOklch(theme.colors.primaryForeground)};
  --color-secondary: ${hexToOklch(theme.colors.secondary)};
  --color-secondary-foreground: ${hexToOklch(theme.colors.secondaryForeground)};
  --color-muted: ${hexToOklch(theme.colors.muted)};
  --color-muted-foreground: ${hexToOklch(theme.colors.mutedForeground)};
  --color-accent: ${hexToOklch(theme.colors.accent)};
  --color-accent-foreground: ${hexToOklch(theme.colors.accentForeground)};
  --color-destructive: ${hexToOklch(theme.colors.destructive)};
  --color-destructive-foreground: ${hexToOklch(theme.colors.destructiveForeground)};
  --color-border: ${hexToOklch(theme.colors.border)};
  --color-input: ${hexToOklch(theme.colors.input)};
  --color-ring: ${hexToOklch(theme.colors.ring)};
  --color-chart-1: ${hexToOklch(theme.colors.chart1)};
  --color-chart-2: ${hexToOklch(theme.colors.chart2)};
  --color-chart-3: ${hexToOklch(theme.colors.chart3)};
  --color-chart-4: ${hexToOklch(theme.colors.chart4)};
  --color-chart-5: ${hexToOklch(theme.colors.chart5)};
  --color-sidebar: ${hexToOklch(theme.colors.sidebar)};
  --color-sidebar-foreground: ${hexToOklch(theme.colors.sidebarForeground)};
  --color-sidebar-primary: ${hexToOklch(theme.colors.sidebarPrimary)};
  --color-sidebar-primary-foreground: ${hexToOklch(theme.colors.sidebarPrimaryForeground)};
  --color-sidebar-accent: ${hexToOklch(theme.colors.sidebarAccent)};
  --color-sidebar-accent-foreground: ${hexToOklch(theme.colors.sidebarAccentForeground)};
  --color-sidebar-border: ${hexToOklch(theme.colors.sidebarBorder)};
  --color-sidebar-ring: ${hexToOklch(theme.colors.ring)};
  --font-sans: var(--font-geist-sans);
  --font-mono: var(--font-geist-mono);
  --radius-sm: ${(theme.spacing.radiusSm / 16).toFixed(3)}rem;
  --radius-md: ${(theme.spacing.radiusMd / 16).toFixed(3)}rem;
  --radius-lg: ${(theme.spacing.radiusLg / 16).toFixed(3)}rem;
  --radius-xl: ${(theme.spacing.radiusXl / 16).toFixed(3)}rem;
}`;
  };
  ...
  const handleCopyGlobalsCss = () => {
    navigator.clipboard.writeText(generateGlobalsCss());
    toast.success("CSS copied! Replace @theme inline block in globals.css");
  };

  const handleDownloadGlobalsCss = () => {
    const blob = new Blob([generateGlobalsCss()], { type: "text/css" });
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = `theme-${theme.name.toLowerCase().replace(/\s+/g, "-")}.css`;
    a.click();
  ...
  return (
    <Page title="Theme Builder" subtitle="Customize your app's visual design and export to globals.css">
      ...
      <Modal
        ...
        title="Apply Theme"
        subtitle="Copy this CSS into your globals.css"
      >
        <div className="space-y-4">
          <div className="bg-gray-900 rounded-lg p-4 max-h-64 overflow-auto">
            <pre className="text-xs text-green-400 font-mono whitespace-pre">
          ...
          <p className="text-xs text-muted-foreground">
            Replace the <code className="bg-muted px-1 rounded">@theme inline</code> block in <code className="bg-muted px-1 rounded">globals.css</code> with this CSS.
          </p>
          <div className="flex justify-end gap-2">
            <Button variant="outline" onClick={() => setApplyModalOpen(false)}>
              Cancel
            </Button>
            <Button variant="outline" onClick={handleCopyGlobalsCss}>
              <Copy className="w-4 h-4 mr-2" />
              Copy
            </Button>
            <Button onClick={handleDownloadGlobalsCss}>
